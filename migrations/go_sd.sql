...
--
-- Host: localhost    Database: mysql_sd_go
-- ------------------------------------------------------
...
--
-- Current Database: `mysql_sd_go`
--

/*!40000 DROP DATABASE IF EXISTS `mysql_sd_go`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `mysql_sd_go` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `go_crm_user` (
  ...
  `usr_login_at` int NOT NULL DEFAULT '0' COMMENT 'Last Login Time',
  `usr_login_ip_at` varchar(12) NOT NULL DEFAULT '' COMMENT 'Last Login IP',
...
CREATE TABLE `go_crm_user_v2` (
  ...
  `usr_login_at` int NOT NULL COMMENT 'Last Login Time',
  `usr_login_ip_at` longtext NOT NULL COMMENT 'Last Login IP',
...
-- Dump completed on 2024-09-29 12:51:16
